...
class OthersController extends Controller
{
    ...
    public function follow(){
        ...
        DB::insert('insert into followers (user_id, following_id, created_at, updated_at) values (?, ?, ?, ?)', 
            [$follower_id, $following_id, Carbon::now(), Carbon::now()]);
    ...
    public function unfollow(){
      ...
      //  DB::table('followers')->where('user_id', '=', $follower_id)->where('following_id', '=', $following_id)->delete();
        ...
        DB::delete('delete from followers where user_id = ? and following_id = ?', [$follower_id, $following_id]);
