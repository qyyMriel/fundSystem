...
class UserController extends Controller
{
    ...
    public function storeprofile(CreateUserProfileRequest $request){
        ...
        DB::insert('insert into user_profiles (id, imagename, hometown, birthday, interest, creditcard, legalname) values (?, ?, ?, ?, ?, ?, ?)', [$id, $imageName, $request['hometown'],$request['birthday'], $request['interest'], $request['creditcard'], $request['legalname']]);
